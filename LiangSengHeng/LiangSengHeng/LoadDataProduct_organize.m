...
#import "Connect.h"
@implementation LoadDataProduct_organize
-(void) loadFormData{
    ...
    NSString *serverUrl = [NSString stringWithFormat:@"%@%@%@%@",http,BASE_URL,products,get_gold_price_organize];
...
- (void)connection:(NSURLConnection *)connection didFailWithError:(NSError *)error {
    ...
    [self.delegate loadFormDataFailed_organize];
}
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
    ...
    [self.delegate loadFormDataDidFinish_organize:formData];
